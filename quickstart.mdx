...
<AccordionGroup>
  <Accordion icon="log" title="Créer mon compte LineChat">
   Accédez à LineChat sur notre site offciel et créez un compte gratuitement (https://linechat.co). Notez que nous utilisons vos informations uniquement dans le cadre de notre logiciel, votre numéro de téléphone est requis afin de limiter le nombre de comptes créés.
  </Accordion>
