...
<Info>L'IA fonctionne avec des données entrantes et sortantes, **configurez donc avant une carte "question" et sauvegardez la requete de l'utilisateur dans une variable**. [Regardez cette vidéo pour plus d'infos.](https://platform.openai.com/docs/introduction) </Info>
